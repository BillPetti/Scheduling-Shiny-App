...
write.csv(Pitchers, file="C:/Users/Petti/Default Sync Folder/Baseball Data/Baseball Data/Edge_Percent/edge_percent/edge_shiny/data/Pitchers_Edge.csv", row.names=FALSE, col.names=TRUE, na="")
